...
/* ============================================================
   SPLIT TEXT REVEAL — letter-by-letter cinematic entrance
   ============================================================ */
...
/* ============================================================
   ANIMATED CHECK ICON — SVG path draws in
   ============================================================ */
function DrawCheck({ delay = 0 }) {
  return (
    <span className="w-5 h-5 rounded-full bg-white/[0.06] border border-white/10 flex items-center justify-center shrink-0">
...
/* ============================================================
   ANIMATED BACKGROUND — mesh gradient + drifting light beams
   ============================================================ */
...
/* ============================================================
   FEATURE ROW — icon + text, animated on view
   ============================================================ */
    ...
    <div className="min-h-screen grid lg:grid-cols-[1.05fr_1fr] bg-white dark:bg-[#0a0a0a]">
        ...
        <div className="relative z-10 flex flex-col justify-between w-full p-14 text-white">
          ...
          <div className="max-w-lg">
            <h1 className="font-display text-[46px] leading-[1.06] font-semibold tracking-[-0.025em] mb-6">
              <SplitText text="The running" delay={0.15} />
              <br />
              <span className="bg-gradient-to-r from-amber-300 to-orange-400 bg-clip-text text-transparent">
                <SplitText text="Rklogix for every" delay={0.35} />
              </span>
              <br />
              <SplitText text="deal you close." delay={0.75} />
            </h1>
            ...
            >
              Track pipeline stages, assign leads across your team, and never
              let a follow-up slip — backed by a cached dashboard that stays
              fast at scale.
            </motion.p>
            ...
            <ul className="mt-10 space-y-3.5">
              <FeatureRow
                icon={Zap}
                text="Real-time pipeline analytics"
                delay={1.4}
              />
              <FeatureRow
                icon={Users}
                text="Role-based team assignment"
                delay={1.55}
              />
              <FeatureRow
                icon={Shield}
                text="Redis-cached, sub-50ms queries"
                delay={1.7}
              />
            </ul>
            ...
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.7, delay: 2, ease: EASE }}
              className="mt-12 flex items-center gap-8"
            >
              <div>
                <div className="text-[22px] font-semibold text-white tabular-nums">
                  <Counter to={2400} delay={2100} suffix="+" />
                </div>
              ...
              <div>
                <div className="text-[22px] font-semibold text-white tabular-nums">
                  <Counter to={48} delay={2200} suffix="ms" />
                </div>
                <div className="text-[11px] text-white/40 uppercase tracking-wider mt-0.5">
                  Avg query
                </div>
              ...
              <div>
                <div className="text-[22px] font-semibold text-white tabular-nums">
                  <Counter to={99} delay={2300} suffix=".9%" />
                </div>
                <div className="text-[11px] text-white/40 uppercase tracking-wider mt-0.5">
                  Uptime
                </div>
      ...
      <div className="relative flex flex-col justify-center px-6 sm:px-12 lg:px-20 py-12">
        ...
        <motion.div
          ...
          className="lg:hidden flex items-center gap-2.5 mb-12 justify-center"
        >
        ...
        >
          ...
          <form onSubmit={submit} className="space-y-5">
            ...
            >
              <div className="flex items-center justify-between">
                <label className="text-[13px] font-medium text-black/70 dark:text-white/70">
                  Password
                </label>
                <Link
                  to="/forgot-password"
                  className="text-[12.5px] text-black/50 dark:text-white/50 hover:text-amber-500 transition-colors"
                >
                  Forgot?
                </Link>
              </div>
          ...
          {/* DIVIDER — lines animate from center */}
          <motion.div
            variants={{
              hidden: { opacity: 0, y: 14 },
              show: {
          ...
          >
            <motion.div whileHover={{ y: -1 }} whileTap={{ scale: 0.985 }}>
              ...
              >
                ...
                <span className="relative">Create a new account</span>
              </Link>
            </motion.div>
          </motion.div>
